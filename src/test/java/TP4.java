...
public class TP4 {
   ...
   /* @Test
    public void exo2() throws UnknownHostException, IOException {
        ...
        Assertions.assertEquals("textes\\code_de_la_propriete_intellectuelle\\L122-5.txt", in.readLine());
        socket.close();
        ...
        out.write("\r\n");
        Assertions.assertEquals("HTTP/1.1 400 OK", in.readLine());
        socket.close();
        ...
        out.write("\r\n");
        Assertions.assertEquals("HTTP/1.1 404 OK", in.readLine());
        socket.close();
